...
dotnet ef dbcontext scaffold $connectionString Npgsql.EntityFrameworkCore.PostgreSQL --output-dir ./Data/Model --context-dir ./Data/Context -c WeatherForecastDbContext --use-database-names --data-annotations --no-build --table hr010 
```
